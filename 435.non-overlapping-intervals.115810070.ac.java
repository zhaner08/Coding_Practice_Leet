...
class Solution {
    public int eraseOverlapIntervals(Interval[] intervals) {
        ...
        //sort by end, if start<end, we are trading 2 intervals for 1, which is not idea, if start> end, since end is ascending order, any start would not matter, we well remove the rest
